...
public class StatisticsComputingWorkerThread implements Runnable {
	...
	private static String update_statement = "UPDATE CATALOG SET CDS_NB_DISTINCT_CAT5=?, CDS_NB_DISTINCT_CAT4=?, CDS_NB_DISTINCT_BRAND=?, CDS_NB_DISTINCT_BRAND_WITHOUT_DEFAULT=?, CDS_NB_DISTINCT_VENDOR=?, CDS_NB_DISTINCT_MAGASIN=?, CDS_NB_DISTINCT_STATE=?, CDS_DISTINCT_CAT5=?, CDS_DISTINCT_CAT4=?, CDS_DISTINCT_BRAND=?, CDS_DISTINCT_VENDOR=?, CDS_DISTINCT_MAGASIN=?, CDS_DISTINCT_STATE=?, CDS_TF_DISTANCE_LIBELLE=?, CDS_TF_IDF_DISTANCE_LIBELLE=?, CDS_LEVENSHTEIN_DISTANCE_LIBELLE=?, CDS_TF_DISTANCE_DESCRIPTION80=?, CDS_TF_IDF_DISTANCE_DESCRIPTION80=?, CDS_LEVENSHTEIN_DISTANCE_DESCRIPTION80=?, TO_FETCH=false where SKU=?";
