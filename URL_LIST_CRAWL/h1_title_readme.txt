...
INSERT INTO HTTPINFOS_LIST (URL,STATUS,DESCRIPTION,TO_FETCH)
    VALUES ('http://www.cdiscount.com/',-1,'Dummy',TRUE);
INSERT INTO HTTPINFOS_LIST (URL,STATUS,DESCRIPTION,TO_FETCH)
    VALUES ('http://www.cdiscount.com/informatique/v-107-0.html',-1, 'Dummy',TRUE);
INSERT INTO HTTPINFOS_LIST (URL,STATUS,DESCRIPTION,TO_FETCH)
    VALUES ('http://www.cdiscount.com/electromenager/v-110-0.html',-1,'Dummy',TRUE);


Soit updater des anciennes (d'où le champ description pour gérer des sujets)
UPDATE HTTPINFOS_LIST SET TO_FETCH=true WHERE description= 'pagination_sitemap';
UPDATE HTTPINFOS_LIST SET TO_FETCH=true WHERE URL like '%/v-%';



Lancer l'exécutable (copier le jar et le mettre là où vous voulez ):
cd /home/sduprey/My_Executable;
java -jar h1title_fetching.jar myuseragent mydescription nb_threads size_bucket
