...
public class BatchComparingURLProductsListWorkerThread implements Runnable {
	...
	public BatchComparingURLProductsListWorkerThread(Connection con ,List<Integer> to_fetch, String my_user_agent, String[] xpathExpressions) throws SQLException{
