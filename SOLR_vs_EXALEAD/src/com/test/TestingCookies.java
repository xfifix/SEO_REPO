...
public class TestingCookies {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException{
		...
		for (int i=0;i<100;i++){
			...
			String fiche_produit_url = "http://www.recette-cdiscount.com/juniors/figurines/dc-comics-new-52-terre-2-superman-action-figure/f-1206740-dcd0761941320083.html";
