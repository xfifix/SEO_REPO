...
public class InternationalMultipleIPsCronJob {
		...
		try{	
			...
			while (group_resultSet.next()) {
				...
				while (keyword_resultSet.next()) {
					...
					RankInfo loc_info = proxy_ranking_keyword(keyword_name,target,international_domain);
	...
	public static RankInfo proxy_ranking_keyword(String keyword, String targe_name, String international_domain){
