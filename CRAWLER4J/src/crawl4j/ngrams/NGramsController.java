...
public class NGramsController {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Starting the NGrams crawl configuration");
		// localized seed
		...
		String rootFolder = "/home/sduprey/My_Data/My_NGrams_Crawl4j";
		...
		System.out.println("Starting the NGrams crawl");
		long startTime = System.currentTimeMillis();
		controller.start(NGramsCrawler.class, numberOfCrawlers);
		long estimatedTime = System.currentTimeMillis() - startTime;
		List<Object> crawlersLocalData = controller.getCrawlersLocalData();
		long totalTextSize = 0;
		int totalProcessedPages = 0;
		for (Object localData : crawlersLocalData) {
			NGramsCrawlDataManagement stat = (NGramsCrawlDataManagement) localData;
