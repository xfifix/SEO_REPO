...
public class ExaleadOfferMatchingPostExample {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException{
		...
		// semantic input
		String title = "Rideau tamisant à nouettes uni 100% lin lavé 140x280cm PURETE Décoclico Maison";
		System.out.println("Offer matching for title : "+title);
		String semantic_hits = "lavé@purete@lin@linge@décoclico@unie@tamisant@marques@rideau@nouettes";
		String titleSemantics = "purete@maison@lavé@lin@nouettes@rideau@140x280cm@uni@décoclico@tamisant";
