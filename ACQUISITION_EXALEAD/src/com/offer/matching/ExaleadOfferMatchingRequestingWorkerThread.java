...
public class ExaleadOfferMatchingRequestingWorkerThread implements Runnable {
	...
	public ExaleadOfferMatchingRequestingWorkerThread(Connection con ,String tablename) {
		this.con=con;
		try {
	...
	public void run() {
		List<OfferMatchingRequestResults> infos=processCommand();
		updateStatus(infos);
		System.out.println(Thread.currentThread().getName()+" End");
	}

	// batched update
	private void updateStatus(List<OfferMatchingRequestResults> infos){
		...
		try {
			...
			for (OfferMatchingRequestResults results : infos){			
	...
	private List<OfferMatchingRequestResults> processCommand() {
		List<OfferMatchingRequestResults> my_fetched_infos = new ArrayList<OfferMatchingRequestResults>();
