...
//		}
	...
	// update step by step
	private void updateStatusStepByStep(List<FacettesURLComparisonInfo> infos){
		System.out.println("Adding to batch : " + infos.size() + "ULRs into database");
//		try {
//			PreparedStatement st = con.prepareStatement(updateStatement);
//			for (int i=0;i<infos.size();i++){
...
//		}
	...
	private List<FacettesURLComparisonInfo> processComparison(List<ULRId> line_infos) {
